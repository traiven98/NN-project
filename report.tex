...
{\normalsize Neuronové sítě \par}
    ...
    \begin{abstract}
        \noindent
        Tato zpráva představuje systém supervizované vícetrídní klasifikace
        dermatoskopických snímků kožních lézí s využitím datasetu HAM10000
        (10\,015 snímků, 7 tříd). Porovnáváme dvě architektury: čtyřvrstvou
        \textbf{základní CNN} trénovanou od nuly a \textbf{ResNet18}
        jemně doladěnou z vah ImageNet pomocí dvou-fázové tréninkové strategie.
        Hlavní výzvou je výrazná nerovnováha tříd ---
        \textit{Melanocytární névus} tvoří 67\,\% všech vzorků ---
        řešená pomocí \texttt{WeightedRandomSampler}. Modely jsou hodnoceny
        pomocí váženého F1-skóre, AUC-ROC pro jednotlivé třídy
        a vizualizačních map Grad-CAM.
        Přenosové učení výrazně překonalo základní linii:
        ResNet18 dosáhlo přesnosti 77{,}30\,\% a makro AUC-ROC 0{,}9495,
        ve srovnání s 59{,}72\,\% přesnosti základní CNN,
        v souladu s referenční hodnotou $\sim$80\,\% přesnosti ResNet18
        na tomto datasetu.
    \end{abstract}
\end{titlepage}
...
a podléhá mezipozorovatelské variabilitě.
...
zahrnujících benigní, prekancerózní a maligní léze. Úloha je formulována
jako \textbf{supervizovaná vícetrídní klasifikace obrázků}, přičemž
referenční štítky jsou potvrzeny histopatologií, klinickým sledováním
nebo expertním konsenzem.

Jsou porovnávány dva modely:
\begin{itemize}
