...
Včasná diagnóza výrazně zlepšuje prognózu pacienta, avšak přesné rozlišení
maligních a benigních lézí je náročné i pro zkušené odborníky.
...
oproti prostému vizuálnímu vyšetření. Přesná interpretace dermatoskopických
snímků je však závislá na odbornosti lékaře, časově náročná a podléhá
mezipozorovatelské variabilitě. Automatizované systémy počítačového vidění
proto představují slibný nástroj pro podporu klinického rozhodování.
...
\begin{itemize}
    ...
    \item \textbf{ResNet18 s přenosovým učením}: reziduální síť
          předtrénovaná na datasetu ImageNet
...
mapy Grad-CAM, které potvrzují, že síť
...
ResNet18 se skládá z konvoluční kmenové části
...
Mapping (Grad-CAM) produkuje prostorovou tepelnou mapu
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{plots/gradcam_results.jpg}
...
\begin{itemize}
    ...
    \item \textbf{Pokročilá augmentace}: MixUp nebo CutMix interpoluje
          mezi trénovacími vzorky a jejich štítky, čímž model dále
          regularizuje.
